...
// HINT: Using .map will be very helpful when itterating through the ingredients array.
 ...
 main = document.getElementsByClassName("recipes");
// console.log(main);
var tag = main[0];
...
var print = () => {
    for( var i=0; i<recipes.length;i++){
        ...
        recCont.innerHTML = `${recipes[i].title} <br> Time: ${recipes[i].time}
           <br> Calories : ${recipes[i].calories} <br> Ingredients: ${recipes[i].ingredients}`
